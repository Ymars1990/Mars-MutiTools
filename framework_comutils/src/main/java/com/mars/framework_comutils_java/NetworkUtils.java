...
public class NetworkUtils {
     ...
     */
    public static void openWirelessSettings(Context mCtx) {
        mCtx.startActivity(
    ...
    public static boolean isConnected(Context mCtx) {
        NetworkInfo info = getActiveNetworkInfo(mCtx);
     ...
     */
    @RequiresPermission(ACCESS_NETWORK_STATE)
    public static boolean isMobileData(Context mCtx) {
        NetworkInfo info = getActiveNetworkInfo(mCtx);
        return null != info
                && info.isAvailable()
     ...
     */
    @RequiresPermission(ACCESS_NETWORK_STATE)
    public static boolean is4G(Context mCtx) {
        NetworkInfo info = getActiveNetworkInfo(mCtx);
        return info != null
                && info.isAvailable()
    ...
    public static boolean getWifiEnabled(Context mCtx) {
        @SuppressLint("WifiManagerLeak")
        WifiManager manager = (WifiManager) mCtx.getSystemService(WIFI_SERVICE);
    ...
    public static void setWifiEnabled(final boolean enabled,Context mCtx) {
        @SuppressLint("WifiManagerLeak")
        WifiManager manager = (WifiManager) mCtx.getSystemService(WIFI_SERVICE);
        //noinspection ConstantConditions
     ...
     */
    @RequiresPermission(ACCESS_NETWORK_STATE)
    public static boolean isWifiConnected(Context mCtx) {
    ...
    public static boolean isWifiAvailable(Context mCtx) {
        return getWifiEnabled(mCtx) && isAvailableByPing();
    }
     ...
     * @return the name of network operate
     */
    public static String getNetworkOperatorName(Context mCtx) {
        TelephonyManager tm =
     ...
     */
    @RequiresPermission(ACCESS_NETWORK_STATE)
    public static NetworkType getNetworkType(Context mCtx) {
    ...
    @RequiresPermission(ACCESS_NETWORK_STATE)
    private static NetworkInfo getActiveNetworkInfo(Context mCtx) {
     ...
     */
    @RequiresPermission(ACCESS_WIFI_STATE)
    public static String getIpAddressByWifi(Context mCtx) {
        @SuppressLint("WifiManagerLeak")
     ...
     */
    @RequiresPermission(ACCESS_WIFI_STATE)
    public static String getGatewayByWifi(Context mCtx) {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) mCtx.getSystemService(Context.WIFI_SERVICE);
        //noinspection ConstantConditions
     ...
     */
    @RequiresPermission(ACCESS_WIFI_STATE)
    public static String getNetMaskByWifi(Context mCtx) {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) mCtx.getSystemService(Context.WIFI_SERVICE);
        //noinspection ConstantConditions
     ...
     */
    @RequiresPermission(ACCESS_WIFI_STATE)
    public static String getServerAddressByWifi(Context mCtx) {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) mCtx.getSystemService(Context.WIFI_SERVICE);
        //noinspection ConstantConditions
